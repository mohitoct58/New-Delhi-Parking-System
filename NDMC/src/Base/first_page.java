...
public class first_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("An initiative taken by New Delhi Municipal Corporation(NDMC)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try 
        {
            Socket socket = new Socket(InetAddress.getLocalHost(),33334);
            ...
            data_output_stream.writeUTF("DIMTS Login");
        } 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try 
        {
            ...
            DataInputStream data_input_stream = new DataInputStream(socket.getInputStream());
            DataOutputStream data_output_stream = new DataOutputStream(socket.getOutputStream());
            data_output_stream.writeUTF("Police Login");
        } 
        catch (IOException ex)
        {
            ex.printStackTrace();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try 
        {
            ...
            DataInputStream data_input_stream = new DataInputStream(socket.getInputStream());
            DataOutputStream data_output_stream = new DataOutputStream(socket.getOutputStream());
            data_output_stream.writeUTF("Audience");
        } 
        catch (IOException ex)
        {
            ex.printStackTrace();
